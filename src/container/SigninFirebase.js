...
class Signin extends Component {
   ...
   onUserLogin() {
      ...
      if(this.state.email == '' ){
         this.setState({errormsg: 'Enter Email'})
                     ...
                     <div className="container">
                        <div className="d-flex justify-content-between">
                           <div className="session-logo">
                              <Link to="/">
                                 <img src={AppConfig.appLogo} alt="session-logo" className="img-fluid" width="150" height="auto" />
                              </Link>
                           </div>
                           {/* <div>
                              ...
                              <Form>
                                 ...
                                 <FormGroup className="mb-15">
                                    ...
                                    >
                                     ...
                                     {/* <Button component={Link} to="/system_admin/session/forgot-password" className="btn-dark btn-block btn-large text-white w-100">Forgot Password?</Button> */}
                                 </FormGroup>
