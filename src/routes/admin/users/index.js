...
import { getAllPost, handlePostStatus, deletePost } from './../../../api'
...
const acceptable_user_roles = ["super_admin", "sip_admin", "sip_progress_management"]
const dashboard = [
    "dashboard",
];
const back = [
...
class Index extends Component {
    ...
    render() {
        ...
        const { postListData, loadData, FileUrl, deleteWarning, askStatus, statusChangeText, success, viweDetails, viewData } = this.state
        ...
        return (
            <Container>
                ...
                <SweetAlert
                    ...
                    onCancel={() => this.onCancel('deleteWarning')}>
