				...
				<div className="row">
					<div className="col-sm-12 col-md-12 col-lg-12">
						...
						<div className="row">
							...
							<span><span className="material-icons icons-middle">{dashboard}</span> Dashboard / Properties / csv Upload</span>
						    </div>
						</div>
						<div className="row">
						<div className="col-md-6 col-sm-12 col-xl-4 bg-cont-pad">
						    ...
						    <div className="col-md-12 col-sm-12 col-xl-12 Add-panel-container bottom-border">
								<div className="row">
									...
									<span><span aria-hidden="true" className={panel}></span>Add Panel</span>
								    </div>
								</div>
						    </div>
							<div className="col-md-12 col-sm-12 col-xl-12 p-4">
								<div className="row">
									...
									<div className="row">
									    <div className="col-md-12 col-sm-12 col-xl-12">
										  <FormGroup>
										  	<Label className="star">DEVELOPMENT <span>*</span></Label>
									...
									<div className="row">
										<div className="col-md-12 col-sm-12 col-xl-12 ">
										  <FormGroup>
										  	<Label className="star">UPLOAD CSV <span>*</span></Label>
											 <div className="bg-light p-2 upload-container"><Input type="file" name="file" id="File" /></div>
										  </FormGroup>
									    </div>
									</div>
									<div className="row">
										...
										<Button color="primary" className="custom-button material-icons">{dashboard} START UPLOAD</Button>
									    </div>
									</div>
								    </div>
								</div>
