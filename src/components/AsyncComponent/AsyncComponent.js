...
const Loginform = Loadable({
   loader: () => import("Routes/admin/login"),
   loading: () => <RctPageLoader />,
});

const Logout = Loadable({
   loader: () => import("Routes/admin/logout"),
   loading: () => <RctPageLoader />,
});


const ForgotPassword = Loadable({
   loader: () => import("Routes/admin/forgotpassword"),
   loading: () => <RctPageLoader />,
});


const AccountForm = Loadable({
   loader: () => import("Routes/admin/account"),
   loading: () => <RctPageLoader />,
});

const Asyncuploads = Loadable({
   loader: () => import("Routes/admin/uploads"),
   loading: () => <RctPageLoader />,
});
const Asynctool = Loadable({
   loader: () => import("Routes/admin/tool"),
   loading: () => <RctPageLoader />,
});
const Asynccategory = Loadable({
   loader: () => import("Routes/admin/category"),
   loading: () => <RctPageLoader />,
});
const Asynccontent = Loadable({
   loader: () => import("Routes/admin/content"),
   loading: () => <RctPageLoader />,
});

const DashDevelopments = Loadable({
   loader: () => import("Routes/admin/developments"),
   loading: () => <RctPageLoader />,
});
...
const SettingsRoute = Loadable({
   loader: () => import("Routes/admin/settings/settings_route"),
   loading: () => <RctPageLoader />,
});

const AsyncCalculations = Loadable({
   loader: () => import("Routes/admin/settings/terms"),
   loading: () => <RctPageLoader />,
});
...
const AsyncDataUsage = Loadable({
   loader: () => import("Routes/admin/settings/data_usage"),
   loading: () => <RctPageLoader />,
});

const AsyncPostList = Loadable({
   loader: () => import("Routes/admin/posts"),
   loading: () => <RctPageLoader />,
})
