...
export default {
   category1: [
      ...
      },
      {
         ...
         "child_routes": [
            {
               "path": "/system_admin/session/login",
               "new_item": false,
               "menu_title": "sidebar.login"
            },
            {
               "path": "/system_admin/session/register",
               "new_item": false,
               "menu_title": "sidebar.register"
            },
            {
               "path": "/system_admin/session/lock-screen",
               "new_item": false,
            ...
            {
               "path": "/system_admin/session/404",
               "new_item": false,
               "menu_title": "sidebar.404"
            },
            {
               "path": "/system_admin/session/500",
               "new_item": false,
