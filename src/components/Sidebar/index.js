...
class Sidebar extends Component {
	...
	render() {
		...
		return (
			<Fragment>
				<div
					className="background-none backgroud-col rct-sidebar"
					
				>
					<div className="rct-sidebar-content">
						<div className="site-logo">
							<Link to="/" className="logo-mini siteLogo 111">
								<img src={require('Assets/img/weblogo12.png')} style={{borderRadius:"8px"}} className="mr-15" alt="site logo" />
							</Link>
...
const mapStateToProps = ({ settings, authUser }) => {
	...
	return { enableSidebarBackgroundImage, selectedSidebarImage, collapsedSidebar, isDarkSidenav, locale, token };
};
