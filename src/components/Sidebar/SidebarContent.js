            ...
            <div className="rct-sidebar-nav">
                <nav className="navigation">
                    <List
                        ...
                        subheader={
                            <ListSubheader className="side-title main-nav" component="li">
                    ...
                    {/* <List
                        className="rct-mainMenu p-0 m-0 list-unstyled"
                        subheader={<ListSubheader className="side-title main-nav" component="li"> */}
